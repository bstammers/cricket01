...
describe BatsmenController do
  before :each do
    @match = FactoryGirl.create(:match)
    @inning = FactoryGirl.create(:inning, match_id: @match.id)
    @batsman = FactoryGirl.create(:batsman, inning_id: @inning.id)
    @batsman_attributes = FactoryGirl.attributes_for(:batsman, inning_id: @inning)
  end
  ...
  describe "GET 'show'" do
    it "should get show" do
      get :show, inning_id: @inning.id, id: @batsman.id
